...
fuente exacta — nada de esto es dato de RetailCo, son marcos de referencia y
benchmarks de OTRAS empresas/estudios que hay que citar así, nunca presentar como
hecho propio de RetailCo.
...
- La cátedra propone armar una matriz 2x3 relevando TODOS los canales de
  ...
  mapear los canales reales de RetailCo en esta matriz (con research real, no
...
- Casos con resultados medibles (**no son de RetailCo, son benchmarks de otras
