---
fuente: Dossier Negocio e Infraestructura RetailCo.pdf (Fases 6, 7, 8 y 9 — Modelo Paramétrico de Demanda, Componentes Técnicos y Arquitectura de Referencia, Costos de IA e Infraestructura Cloud, Costos de Implementación)
...
| Métrica | Piloto | Intermedio | Escala RetailCo |
|---|---|---|---|
...
registrada de RetailCo Community — **hereda la incertidumbre [SV] del padrón de
RetailCo Community** ya señalada en `RetailCo-dimension-negocio.md`.
...
integración con POS/ERP/CRM de RetailCo → todo bajo guardrails y observabilidad.
...
| Proveedor | Modelo | Entrada estándar | Entrada con caché | Salida | Uso ideal en RetailCo |
|---|---|---|---|---|---|
...
| Componente | Piloto | Intermedio | Escala RetailCo |
|---|---|---|---|
