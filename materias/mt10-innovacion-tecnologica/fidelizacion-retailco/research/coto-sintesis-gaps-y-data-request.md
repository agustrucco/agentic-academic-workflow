---
fuente: Dossier Negocio e Infraestructura RetailCo.pdf (Fases 15, 17, 18 y 19 — Plan de Medición ext., Data Request Priorizado, Supuestos y Limitaciones Metodológicas, Cierre: Síntesis Estratégica y Siguientes Pasos)
---
...
## Data request priorizado (lo que le falta pedir a RetailCo antes de un diseño definitivo)

**P1 — Imprescindible**

| Dato solicitado | Para qué se necesita | Proxy actual usado en el dossier |
|---|---|---|
| Padrón activo de RetailCo Community | Determina el universo real de usuarios alcanzables | Rango estimado 3,5M–5,0M de socios |
| Distribución de venta por categoría y margen | Margen de contribución real por canasta | Margen promedio sectorial 21,5% |
| Mix transaccional de medios de pago en caja | Costo de adquirencia real y oportunidad de RetailCo Card | Datos consolidados INDEC (45% crédito, 23,9% débito) |
...
| Tasa de descarte/sustitución en RetailCo Digital | ROI del agente de sustitutos para pickers | Benchmark e-commerce retail (12% tasa de descarte) |
...
| Métricas de RetailCo Card (emisión y morosidad) | Capacidad financiera de expandir crédito propio vía app | Benchmark de tarjetas de crédito no bancarias |

## Síntesis estratégica del dossier (qué sabemos / qué estimamos / qué no podemos calcular)

**Qué sabemos con evidencia** (fuentes primarias/oficiales): RetailCo lidera el
mercado con 22,3% de share; red de 120+ sucursales, 1 CD, 3 frigoríficos;
RetailCo Digital lidera e-commerce con 50% más de volumen de pedidos que su
...
**Qué podemos estimar por proxy**: penetración de RetailCo Digital 4,5%–6,0% de
...
resúmenes de RetailCo Card; margen de contribución exacto por categoría de SKU;
presupuesto anual de promociones 100% financiadas por RetailCo; costo real por
ticket de soporte; padrón de socios activos de RetailCo Community.
...
2. Migración de medios de pago a RetailCo Card (mayor liquidez neta directa).
...
3. WMS y terminales de pickers en RetailCo Digital (sustitutos recomendados).
...
- **Baja viabilidad / alto riesgo**: aprobación 100% autónoma de crédito o
  aumento de límite en RetailCo Card (Nivel 5 — riesgo de incobrabilidad y
