---
fuente: Dossier Negocio e Infraestructura RetailCo.pdf (Fase 4 — Ecosistema de Actores y Flujos de Valor)
---

# Ecosistema de actores y flujos de valor

El dossier arma una matriz de actores internos y externos que participan del
negocio de RetailCo, cada uno con su rol, qué aporta, qué recibe, costos/ingresos
...
| RetailCo Community | Programa de beneficio/identificación | Trazabilidad del perfil de consumo | Descuentos exclusivos (ej. 15% en días clave) | Proceso de alta complejo, falta de personalización en ofertas |
| RetailCo Card | Entidad de crédito propia | Medio de pago propio, financiamiento exclusivo | Lealtad de pago, captura de aranceles financieros | Límite de crédito insuficiente, tasa de interés percibida alta |
...
| Sistemas / Data RetailCo | Infraestructura IT y soporte digital | Plataformas operativas (POS, ERP, CRM, RetailCo Digital) | Presupuesto tecnológico, inversión cloud | Sistemas legacy heredados, dificultad de integración en tiempo real |

## Flujo financiero

- El desembolso del cliente hacia RetailCo se canaliza vía adquirentes o efectivo
  directo.
- Transacciones con tarjetas de terceros generan retenciones arancelarias del
  **1,5% al 2,5%** del valor bruto.
- La captura vía **RetailCo Card retiene el 100% del valor dentro del grupo
...
- **35%–45%** de las transacciones presenciales se liquidan sin DNI/carnet de
  RetailCo Community → se disocia el ticket del perfil del cliente.
- La adquirencia bancaria externa bloquea la visibilidad de hábitos de
  consumo del cliente fuera de sucursales RetailCo.
...
`RetailCo-procesos-y-casos-de-uso-agenticos.md`): el cliente presencial/digital es
el usuario final de los asistentes de promociones y sustitución; Operaciones/
Cajas es quien opera junto al agente en el punto de venta; Sistemas/Data RetailCo
...
del caso de ROI vía RetailCo Card.
