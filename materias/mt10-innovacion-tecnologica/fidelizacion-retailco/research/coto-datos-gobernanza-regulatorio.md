---
fuente: Dossier Negocio e Infraestructura RetailCo.pdf (Fases 14 y 16 — Inventario de Datos, Arquitectura de Información y Gobernanza)
---
...
|---|---|---|---|---|
| Perfil del cliente | CRM RetailCo Community | Alta (PII) | 98% (DNI/email validado) | Ley 25.326 (Protección de Datos) |
...
| Medios de pago y RetailCo Card | Core bancario / RetailCo Card | **Crítica (PCI)** | 100% (tokenizado PCI DSS) | Vulneración de datos de tarjeta / normas BCRA |
...
- **Normas del BCRA para Proveedores de Servicios de Pago (PSP)**: aplican
  ante cualquier integración con RetailCo Card o módulos de billetera, incluida
...
de RetailCo Community tiene que mencionar explícitamente cómo cumple la Ley
25.326, y cualquier componente que toque la RetailCo Card tiene que mencionar
