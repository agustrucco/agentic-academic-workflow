---
fuente: Dossier Negocio e Infraestructura RetailCo.pdf (Fase 3 — Modelo Económico del Negocio y Unit Economics)
...
RetailCo Community · `Costo_CS` = costo asignado de atención al cliente.
...
1. **Promociones 100% RetailCo**: descuentos de RetailCo Community (ej. 15% en un
   pago) y ofertas en marcas propias. Erosión directa sobre el margen bruto
   de la empresa.
2. **Promociones cofinanciadas (proveedor–RetailCo)**: descuentos por volumen
...
3. **Promociones 100% entidad financiera**: reintegros aplicados por bancos
   ...
   Pago) en el extracto del cliente. RetailCo no erosiona su margen bruto acá,
   pero asume la fricción operativa de validación en caja.

## RetailCo Card (Tarjeta RetailCo Integrada)

Tarjeta de crédito propia emitida por RetailCo S.A. [DC, fuente 13].
...
- Construir **trazabilidad transaccional absoluta del cliente**,
  independientemente del uso del carnet de RetailCo Community.

**Implicancia directa para la plataforma de fidelización**: la migración de
medios de pago de terceros hacia RetailCo Card es, por diseño, la palanca con mejor
...
- Entre el **35% y el 45%** de las transacciones presenciales en salón se
  ...
  su DNI o carnet de RetailCo Community** [EC/SV según el dossier]. Esto disocia
...
- Los eventos de navegación en RetailCo Digital **no están integrados
