---
fuente: Dossier Negocio e Infraestructura RetailCo.pdf (Fases 10, 11, 12 y 13 — Árbol de Valor y Beneficios Económicos, Modelo Financiero de ROI/VAN/Payback, Métricas, Plan de Medición de Incrementalidad)
...
| 3 | Reducción de comisiones de pago (RetailCo Card routing) | 45% tarjeta de crédito externa | +5,0% migración a RetailCo Card | $480.000 | Alto [EC] |
...
| Margen de contribución promedio RetailCo | 18,0% | 21,5% | 24,0% |
...
- **Diseño experimental**: filtrado por segmento RFM sobre la base de socios
  RetailCo Community, desdoblamiento aleatorio 90% Grupo Test (expuesto a
...
- **Control de canibalización de canales**: verificar si el crecimiento de
  RetailCo Digital viene de migración de compras que el mismo cliente ya hacía en
...
1. **No presentar el ROI de 1.505,7% ni el VAN de $5,24M como el número
   ...
   [SV] (ver `RetailCo-dimension-negocio.md`). Presentar en cambio el rango
...
2. **Separar claramente qué palancas dependen de comportamiento del cliente
   ...
   interna (3 — migración a RetailCo Card, la de mayor confianza).** El caso más sólido
