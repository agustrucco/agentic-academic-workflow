...
Retail de supermercados en Argentina. Empresa de referencia: **RetailCo
C.I.C.S.A.**, líder del mercado con **22,3% de participación** (rango
21,5%–23,5%), por encima de Carrefour (21%), Cencosud (17%), La Anónima
(12,5%), Día (9%) y Changomás (8,7%). *(`RetailCo-dimension-negocio.md`)*

Rasgos distintivos de RetailCo frente al resto de la industria:
...
- **RetailCo Digital es el líder indiscutido de e-commerce de supermercados**
...
Nota de framing sugerida para la redacción: RetailCo no es una empresa que
...
- **Entre el 35% y el 45% de las transacciones presenciales en salón se
  ...
  RetailCo.** El ticket queda disociado del perfil del cliente.
- La adquirencia bancaria externa (tarjetas de terceros) bloquea la
  ...
  sucursales RetailCo.
- Los eventos de navegación de RetailCo Digital **no están integrados
  analíticamente en tiempo real** con la interacción presencial del mismo
  cliente en tienda física.
*(`RetailCo-modelo-economico-unit-economics.md`, `RetailCo-ecosistema-actores.md`)*
...
- Redes sociales (Instagram ~808K seguidores, Facebook ~1,1M) funcionan
  ...
  alimente el perfil de RetailCo Community/RetailCo Card**, ni de un chatbot
...
- La atención de reclamos vía redes sociales deriva sistemáticamente al
  0800 telefónico (RetailCo hotline) en vez de resolverse en el mismo canal — no
  "cierra el loop" dentro del ecosistema digital de RetailCo.
*(`RetailCo-redes-sociales-omnicanalidad.md`)*
...
Data RetailCo" enfrenta sistemas legacy heredados y dificultad de integración
en tiempo real como fricción propia. *(`RetailCo-ecosistema-actores.md`)*
...
RetailCo Card propia es margen que hoy se fuga a bancos y procesadoras
externas. *(`RetailCo-modelo-economico-unit-economics.md`)*

## 3. Oportunidades actuales de mercado

- **Activo propio ya existente y subutilizado como fuente de dato**: la
  RetailCo Card retiene el 100% del valor dentro del grupo económico (no hay
  ...
  a nivel de plataforma de datos unificada. *(`RetailCo-modelo-economico-unit-economics.md`)*
- **Liderazgo de e-commerce ya consolidado** (RetailCo Digital) como base de
  usuarios digitales activos sobre la que construir, no un canal a crear
  desde cero. *(`RetailCo-dimension-negocio.md`)*
- **Ventana competitiva todavía abierta en wallet propia** (ver punto 4):
  ...
  RetailCo puede posicionarse rápido si actúa, pero la ventana se cierra a
  medida que Carrefour y Cencosud escalan adopción.
- **Beneficio ancla ya fuerte y diferenciado**: 15% de descuento
  martes/jueves de RetailCo Community cubre 2 días por semana, más cobertura
...
| **RetailCo** | **22,3% (líder)** | **No confirmada** — pagos digitales vía Mercado Pago (tercero) | 15% descuento martes/jueves (RetailCo Community) + RetailCo Card (crédito propio, no wallet) |

**Lectura para la redacción**: RetailCo es el líder de mercado y de e-commerce,
pero es el **único de los dos líderes de participación (RetailCo y Carrefour)
...
en este frente específico, al mismo nivel que RetailCo — la brecha real es
contra los dos líderes que sí wallet-earon, no contra el promedio del
mercado.

## 5. Nota metodológica para tp-plan-writer

- La cifra de "Miembros de RetailCo Community" (3,5M–6,5M) está marcada como
...
- No hay research de competidores en redes sociales con la misma
  profundidad que el resto — lo que hay en `RetailCo-redes-sociales-
