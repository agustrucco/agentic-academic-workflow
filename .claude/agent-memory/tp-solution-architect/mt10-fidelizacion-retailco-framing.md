---
name: mt10-fidelizacion-retailco-framing
description: Decisiones de framing y diseño grandes tomadas para la Fase Design del TP de fidelización RetailCo — para no contradecirlas en sesiones futuras (revisión, redacción, slides).
metadata:
  type: project
---

Aplica a: **mt10-innovacion-tecnologica/fidelizacion-retailco**
...
`research/RetailCo-modelo-financiero-roi.md`: no se lidera el pitch con VAN
...
(migración a RetailCo Card — la más sólida), y el plan de des-arriesgamiento (3
...
porque depende de un padrón de RetailCo Community marcado [SV] (supuesto
pendiente de validación) en `research/RetailCo-dimension-negocio.md`. No se
...
propios de RetailCo para dimensionar una palanca de valor independiente en el
...
## 5. Nombre "RetailCo Wallet"

La consigna usa "RetailCo Wallet" como caso de referencia, pero
...
no como producto real de RetailCo. Ningún plan de `plans/` afirma que "RetailCo
